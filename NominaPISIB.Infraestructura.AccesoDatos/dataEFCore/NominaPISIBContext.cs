...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        ...
        optionsBuilder.UseSqlServer("Data Source=(localdb)\\leo;Initial Catalog=NominaPisip;Integrated Security=True");

    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<AprobacionVacaciones>(entity =>
        {
            entity.HasKey(e => e.idAprobacionVacacion).HasName("PK__Aprobaci__7609E86F07D618BC");

            entity.Property(e => e.idAprobacionVacacion).ValueGeneratedNever();

            entity.HasOne(d => d.idSolicitudVacacionNavigation).WithMany(p => p.AprobacionVacaciones)
                .HasForeignKey(d => d.idSolicitudVacacion)
                .HasConstraintName("FK__Aprobacio__idSol__48CFD27E");
        });

        modelBuilder.Entity<Asistencias>(entity =>
        {
            entity.HasKey(e => e.idAsistencia).HasName("PK__Asistenc__4E1AB8940F0C14EF");
            ...
            entity.HasOne(d => d.FKidEmpleadoNavigation).WithMany(p => p.Asistencias)
                ...
                .HasConstraintName("FK__Asistenci__FKidE__5165187F");
        });

        modelBuilder.Entity<Bonificaciones>(entity =>
        {
            entity.HasKey(e => e.idBonificaciones).HasName("PK__Bonifica__AD053A98FB42CA4B");

            entity.Property(e => e.idBonificaciones).ValueGeneratedNever();
            ...
            entity.HasOne(d => d.idEmpleadoNavigation).WithMany(p => p.Bonificaciones)
                ...
                .HasConstraintName("FK__Bonificac__idEmp__59FA5E80");
        });

        modelBuilder.Entity<Contratos>(entity =>
        {
            entity.HasKey(e => e.idContrato).HasName("PK__Contrato__91431FE1E1DB3CA5");
            ...
            entity.HasOne(d => d.FKidContratoTipoNavigation).WithMany(p => p.Contratos)
                ...
                .HasConstraintName("FK__Contratos__FKidC__3F466844");

            entity.HasOne(d => d.FKidEmpleadoNavigation).WithMany(p => p.Contratos)
                .HasForeignKey(d => d.FKidEmpleado)
                .HasConstraintName("FK__Contratos__FKidE__3E52440B");
        });

        modelBuilder.Entity<ContratosTipo>(entity =>
        {
            entity.HasKey(e => e.idContratoTipo).HasName("PK__Contrato__A7A6818BF5C28C67");

            entity.Property(e => e.idContratoTipo).ValueGeneratedNever();
        ...
        {
            entity.HasKey(e => e.idDescuento).HasName("PK__Descuent__33F69846C95B75CE");
            ...
            entity.HasOne(d => d.idEmpleadoNavigation).WithMany(p => p.Descuentos)
                .HasForeignKey(d => d.idEmpleado)
                .HasConstraintName("FK__Descuento__idEmp__571DF1D5");
        });

        modelBuilder.Entity<Empleados>(entity =>
        {
            entity.HasKey(e => e.idEmpleado).HasName("PK__Empleado__5295297CEC0286F1");
            ...
            entity.HasOne(d => d.FKidPuestoNavigation).WithMany(p => p.Empleados)
                ...
                .HasConstraintName("FK__Empleados__FKidP__398D8EEE");
        });

        modelBuilder.Entity<EmpleadosVacacionesTotales>(entity =>
        {
            entity.HasKey(e => e.idEmpleado).HasName("PK__Empleado__5295297C4AFF24CD");
            ...
            entity.HasOne(d => d.idEmpleadoNavigation).WithOne(p => p.EmpleadosVacacionesTotales)
                ...
                .HasConstraintName("FK__Empleados__idEmp__5441852A");
        });

        modelBuilder.Entity<Inasistencias>(entity =>
        {
            entity.HasKey(e => new { e.idLicencia, e.idEmpleado, e.InasistenciaFecha }).HasName("PK__Inasiste__EEEA3ED86C03E1A0");

            entity.HasOne(d => d.idEmpleadoNavigation).WithMany(p => p.Inasistencias)
                .HasForeignKey(d => d.idEmpleado)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__Inasisten__idEmp__4E88ABD4");

            entity.HasOne(d => d.idLicenciaNavigation).WithMany(p => p.Inasistencias)
                .HasForeignKey(d => d.idLicencia)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__Inasisten__idLic__4D94879B");
        });

        modelBuilder.Entity<Licencias>(entity =>
        {
            entity.HasKey(e => e.idLicencia).HasName("PK__Licencia__5FB9A24BE18CB5A6");
        ...
        {
            entity.HasKey(e => e.idNomina).HasName("PK__Nominas__BB6DB6738B759443");

            entity.Property(e => e.idNomina).ValueGeneratedNever();
            ...
            entity.HasOne(d => d.idEmpleadoNavigation).WithMany(p => p.Nominas)
                .HasForeignKey(d => d.idEmpleado)
                .HasConstraintName("FK__Nominas__idEmple__4222D4EF");
        });

        modelBuilder.Entity<Puestos>(entity =>
        {
            entity.HasKey(e => e.idPuesto).HasName("PK__Puestos__ADF48F19AC460E1D");
        ...
        {
            entity.HasKey(e => e.idSolicitudVacacion).HasName("PK__Solicitu__C81F1AB15A5D39EF");

            entity.Property(e => e.idSolicitudVacacion).ValueGeneratedNever();

            entity.HasOne(d => d.idEmpleadoNavigation).WithMany(p => p.SolicitudVacaciones)
                .HasForeignKey(d => d.idEmpleado)
                .HasConstraintName("FK__Solicitud__idEmp__45F365D3");
        });
